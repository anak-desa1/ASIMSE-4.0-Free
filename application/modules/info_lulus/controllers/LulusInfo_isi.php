...
class LulusInfo_isi extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('info_lulus/lulus_isi/list_css');
        $this->load->view('layout/header-bottom', $data);
        $this->load->view('layout/header-notif');
        $this->load->view('layout/main-navigation', $data);
        $this->load->view('info_lulus/lulus_isi/lulus_isi_v', $data);
        $this->load->view('layout/footer-top');
        $this->load->view('info_lulus/lulus_isi/list_js');
    ...
    public function simpan_lulus_data()
    {
        ...
        redirect('info_lulus/lulusInfo_isi');
    }   
