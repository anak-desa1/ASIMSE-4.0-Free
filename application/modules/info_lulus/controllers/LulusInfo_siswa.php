...
class LulusInfo_siswa extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('info_lulus/lulus_siswa/list_css');
        $this->load->view('layout/header-bottom', $data);
        $this->load->view('layout/header-notif');
        $this->load->view('layout/main-navigation', $data);
        $this->load->view('info_lulus/lulus_siswa/lulus_siswa_v', $data);
        $this->load->view('layout/footer-top');
        $this->load->view('info_lulus/lulus_siswa/list_js');
    ...
    public function tambah_lulus()
    {
        ...
        $data['pegawai'] = $this->db->get_where('pegawai', ['email_pegawai' => $this->session->userdata('email_pegawai')])->row_array();
        $this->load->view('info_lulus/lulus_siswa/list_css');
        $this->load->view('info_lulus/lulus_siswa/lulus_siswa_add', $data);
        $this->load->view('info_lulus/lulus_siswa/list_js');
    }
    ...
    function edit_lulus($id)
    {
        ...
        $this->load->view('info_lulus/lulus_siswa/list_css');
        $this->load->view('info_lulus/lulus_siswa/lulus_siswa_edit', $data);
        $this->load->view('info_lulus/lulus_siswa/list_js');
    }
    ...
    public function simpan_lulus()
    {
        ...
        redirect('info_lulus/lulusinfo_siswa');
    }    
    ...
    public function create_lulus()
    {
        ...
        $this->load->view('layout/header-notif');
        $this->load->view('layout/main-navigation', $data);
        $this->load->view('info_lulus/lulus_siswa/lulus_siswa_create', $data);
        $this->load->view('layout/footer-top');
        $this->load->view('info_lulus/lulus_siswa/list_js');
        $this->load->view('layout/footer-bottom');
        $this->benchmark->mark('code_end');
    ...
    public function excel_lulus()
    {
        if (isset($_FILES["file"]["name"])) {
            ...
            redirect('info_lulus/lulusInfo_siswa/create_lulus');
        } else {
            $message = array(
    ...
    public function detail_lulus($id)
    {
        ...
        $this->load->view('info_lulus/lulus_siswa/list_css');        
        $this->load->view('info_lulus/lulus_siswa/lulus_siswa_detail', $data);        
        $this->load->view('info_lulus/lulus_siswa/list_js');        
        $this->benchmark->mark('code_end');
    }
    ...
    public function print_lulus($id_bayar)
    {
        ...
        $mpdf->SetHTMLFooter();
        $html1 = $this->load->view('info_lulus/lulus_siswa/lulus_siswa_detail', $data, TRUE);
