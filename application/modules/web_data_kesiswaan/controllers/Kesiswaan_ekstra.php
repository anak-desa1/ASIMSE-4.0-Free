...
class Kesiswaan_ekstra extends CI_Controller
{
    public function __construct()
    {
        ...
        $this->load->model('KesiswaanEkstra_model', 'sch');
    }
    ...
    public function index()
    {
        ...
        $this->load->view('web_data_kesiswaan/kesiswaan_ekstra/list_v', $data);
    ...
    public function simpan_tambah()
    {
        ...
        redirect('web_data_kesiswaan/kesiswaan_ekstra');
    }
    ...
    {
        $data = ['ekstra_id' => $id];
        $this->db->delete('profil_ekstra', $data);
