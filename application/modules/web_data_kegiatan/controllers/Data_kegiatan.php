...
class Data_kegiatan extends CI_Controller
{
    ...
    public function belajar()
    {
        ...
        $this->load->view('web_data_kegiatan/belajar/list_css');
        $this->load->view('layout/header-bottom');
        $this->load->view('layout/header-notif');
        $this->load->view('layout/main-navigation', $data);
        $this->load->view('web_data_kegiatan/belajar/belajar_v', $data);
        $this->load->view('layout/footer-top');
        $this->load->view('web_data_kegiatan/belajar/list_js');
    ...
    public function tambah()
    {
        ...
        $data['pegawai'] = $this->db->get_where('pegawai', ['email_pegawai' => $this->session->userdata('email_pegawai')])->row_array();
        $this->load->view('web_data_kegiatan/belajar/list_css');
        $this->load->view('web_data_kegiatan/belajar/belajar_add', $data);
        $this->load->view('web_data_kegiatan/belajar/list_js');
    }
    ...
    function edit($id)
    {
        ...
        $this->load->view('web_data_kegiatan/belajar/list_css');
        $this->load->view('web_data_kegiatan/belajar/belajar_edit', $data);
        $this->load->view('web_data_kegiatan/belajar/list_js');
    }
    ...
    public function simpan_tambah()
    {
        ...
        redirect('web_data_kegiatan/belajar');
    }
