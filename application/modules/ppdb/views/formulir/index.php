                ...
                <div class="row">
                  ...
                  <div class="col-12 col-sm-8 col-lg-8">
                    <div class="card-header-action">
                      <a target="_blank" href="<?= base_url() . $this->uri->segment(1, 0)?>/formulir/mpdf_cetak" type="button" class="btn btn-success"><i class="fas fa-print"></i> Cetak Form</a>
                    </div>
                        ...
                        <div class="author-box-details">
                          ...
                          <div class="tab-content" id="myTabContent2">
                            <div class="tab-pane fade show active" id="home3" role="tabpanel" aria-labelledby="home-tab3">
                              <br>
                              <form action="<?= base_url() . $this->uri->segment(1, 0)?>/formulir/simpandatadiri" method="post">
                                ...
                                <!-- <div class="form-group row mb-2">
                                  <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Linkar Kepala</label>
                                  <div class="col-sm-12 col-md-3">
                                    <input type="number" name="linkar_kepala" class="form-control" value="<?= $siswa['linkar_kepala'] ?>" required>
                                  </div>
                                </div> -->
                                <div class="form-group row mb-2">
                            ...
                            <div class="tab-pane fade" id="contact3" role="tabpanel" aria-labelledby="contact-tab3">
                              <br>
                              <form action="<?= base_url() . $this->uri->segment(1, 0)?>/formulir/simpanalamat" method="post">
                                <input type="hidden" name="id_daftar" class="form-control" value="<?= $siswa['id_daftar'] ?>">
                            ...
                            <div class="tab-pane fade" id="profile3" role="tabpanel" aria-labelledby="profile-tab3">
                              <br>
                              <form action="<?= base_url() . $this->uri->segment(1, 0)?>/formulir/simpanortu" method="post">
                                <input type="hidden" name="id_daftar" class="form-control" value="<?= $siswa['id_daftar'] ?>">
                                ...
                                <!-- <div class="form-group row mb-2">
                                  <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">No Telp Rumah</label>
                                  <div class="col-sm-12 col-md-5">
                                ...
                                <div class="form-group row mb-2">
                                  ...
                                  <div class="col-sm-12 col-md-5">
                                    <input type="text" name="nikwali" minlength="1" maxlength="18" class="form-control" value="<?= $siswa['nik_wali'] ?>">
                                  </div>
                                </div>
                                <div class="form-group row mb-2">
                                ...
                                <div class="form-group row mb-2">
                                  <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Pendidikan</label>
                                  <div class="col-sm-12 col-md-7">
                                    <?php echo form_dropdown('pendidikan_wali', $p_pendidikan, $siswa['pendidikan_wali'], 'class="form-control" id="pendidikan_wali" '); ?>
                                  </div>
                                </div>
                                <div class="form-group row mb-2">
                                  <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Pekerjaan</label>
                                  <div class="col-sm-12 col-md-7">
                                    <?php echo form_dropdown('pekerjaan_wali', $p_pekerjaan, $siswa['pekerjaan_wali'], 'class="form-control" id="pekerjaan_wali" '); ?>
                                  </div>
                                </div>
                                <div class="form-group row mb-2">
                                  <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Penghasilan</label>
                                  <div class="col-sm-12 col-md-7">
                                    <?php echo form_dropdown('penghasilan_wali', $p_penghasilan, $siswa['penghasilan_wali'], 'class="form-control" id="penghasilan_wali" '); ?>
                                  </div>
                                </div>
                                <div class="form-group row mb-2">
                        ...
                        <div class="card">
                          <div class="card-body">
                            <div class="author-box-left">
                              <img class="img-profile rounded-circle" style="width: 3rem;" src="<?= base_url() ?>website/assets/img/avatar/avatar-1.png">
