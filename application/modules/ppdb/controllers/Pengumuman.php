...
class Pengumuman extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('ppdb/pengumuman/index', $data);
    ...
    public function edit()
    {
        ...
        $data['contact'] = $this->db->get_where('ppdb_setting')->row_array();
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('web_ppdb_user/sidebar', $data);
            $this->load->view('web_ppdb_user/topbar', $data);
            $this->load->view('ppdb/user/edit', $data);
            $this->load->view('web_ppdb_user/footer');
        } else {
            ...
            if ($upload_image) {
                ...
                $config['upload_path'] = './assets/template_dalam/img/profile/';
                ...
                if ($this->upload->do_upload('image')) {
                    ...
                    if ($old_image != 'default.jpg') {
                        unlink(FCPATH . 'assets/template_dalam/img/profile/' . $old_image);
                    }
    ...
    public function changePassword()
    {
        ...
        $data['user'] = $this->db->get_where('user', ['email' => $this->session->userdata('email')])->row_array();
        $data['contact'] = $this->db->get_where('contact')->row_array();
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('web_ppdb_user/sidebar', $data);
            $this->load->view('web_ppdb_user/topbar', $data);
            $this->load->view('ppdb/user/changepassword', $data);
            $this->load->view('web_ppdb_user/footer');
        } else {
            ...
            if (!password_verify($current_password, $data['user']['password'])) {
                ...
                redirect('ppdb/user/changepassword');
            } else {
