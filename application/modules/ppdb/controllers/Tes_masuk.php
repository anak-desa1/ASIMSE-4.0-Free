   ...
   public function index()
    {
        ...
        $this->load->view('ppdb/tes_masuk/index', $data);
    ...
    public function quiz($id)
    {
        ...
        if ($ceknilai <> 0) {
            redirect('ppdb/tes_masuk/hasil_quiz/' . $id);
        }
        $data = [
        ...
        $this->load->view('web_ppdb_user/sidebar', $data);
        $this->load->view('web_ppdb_user/topbar', $data);
        $this->load->view('ppdb/tes_masuk/quiz_v', $data);
        $this->load->view('web_ppdb_user/footer');
    }
    ...
    public function cekquiz($id) //id materi
    {
        ...
        $this->load->view('web_ppdb_user/sidebar', $data);
        $this->load->view('web_ppdb_user/topbar', $data);
        $this->load->view('ppdb/tes_masuk/quiz_hasil_v', $data);
        $this->load->view('web_ppdb_user/footer');
    }
    ...
    public function lihattugas($id)
    {
        ...
        $this->load->view('web_ppdb_user/sidebar', $data);
        $this->load->view('web_ppdb_user/topbar', $data);
        $this->load->view('ppdb/tes_masuk/tugas_lihat_v', $data);
        $this->load->view('web_ppdb_user/footer');
    }
    ...
    public function kirim_tugas($idtugas)
    {
        ...
        redirect('ppdb/tes_masuk/lihattugas/' . $idtugas);
    }
}
