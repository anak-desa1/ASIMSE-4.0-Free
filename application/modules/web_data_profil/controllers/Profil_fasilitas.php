...
class Profil_fasilitas extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('web_data_profil/profil_fasilitas/list_v', $data);
    ...
    public function tambah()
    {
        ...
        $data['subtitle'] = $data['title'];
        $data['pegawai'] = $this->db->get_where('pegawai', ['email_pegawai' => $this->session->userdata('email_pegawai')])->row_array();
        $this->load->view('web_data_profil/profil_fasilitas/list_css');
        $this->load->view('web_data_profil/profil_fasilitas/list_add', $data);
        $this->load->view('web_data_profil/profil_fasilitas/list_js');
    }
    ...
    function edit($id)
    {
        ...
        $this->load->view('web_data_profil/profil_fasilitas/list_css');
        $this->load->view('web_data_profil/profil_fasilitas/list_edit', $data);
        $this->load->view('web_data_profil/profil_fasilitas/list_js');
    }
    ...
    public function simpan_tambah()
    {
        ...
        redirect('web_data_profil/profil_fasilitas');
    }
